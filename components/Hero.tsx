export default function Hero() {
  return (
    <section className="max-w-[720px] mx-auto px-10 pt-24 pb-20">
      ...
      `}</style>
      <div className="text-[13px] font-medium tracking-wide text-muted uppercase mb-6">
      ...
      <div className="mt-12 flex flex-wrap items-center gap-4">
        ...
        <div className="flex-1 min-w-[80px] relative h-4 flex items-center">
          <span className="w-full border-t border-dashed border-ink/25" />
          <svg
        ...
        <div className="w-full text-[13px] text-faint mt-1">

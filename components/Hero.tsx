...
export default function Hero() {
  return (
    <section className="pt-32 pb-0 flex flex-col items-center text-center">
      <h1 className="font-display text-[clamp(60px,5vw,72px)] font-semibold leading-[1.1] tracking-[-0.01em] text-[#111]">
        Creating is my default.
      </h1>
      <h2 className="font-display text-[clamp(60px,5vw,72px)] font-semibold leading-[1.1] tracking-[-0.01em] text-[#111] mb-20">
        <span className="text-accent">Building</span> is my obsession.
      </h2>
